	    ...
	    <div class="row paddingTopNavbar marginTop">
	        <div class="jumbotron col-md-8 col-md-offset-2">
				...
				<form:form id="productForm" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/addAnswer" commandName="question">
					...
					<fieldset>					
						<legend class="center"><s:message code='Question.Vytvorit.Nadpis'/>
					...
					<div class="form-group">
						<label for="inputQuestion" class="col-sm-3 control-label"><span class="glyphicon glyphicon-asterisk"></span>
							<s:message code='Question.Vytvorit.LZadanie'/></label>
						<div class="col-sm-9">
							<s:message code='Question.Vytvorit.PHTitle' var='phTitle'/>
					...
					<div class="form-group">
					    <label for="inputQuestionType" class="col-sm-3 control-label"><span class="glyphicon glyphicon-asterisk"></span>
					    	<s:message code='Question.Vytvorit.LTyp'/></label>
					    <div class="col-sm-9 selectContainer">
					        <form:select path="ot_typ" class="form-control" id="inputQuestionType">
					            <option value="ABCD"><s:message code='Question.Vytvorit.ABCD'/></option>
					            <option value="text"><s:message code='Question.Vytvorit.text'/></option>
					        </form:select>
					...
					<div class="form-group">
						<label for="inputPoints" class="col-sm-3 control-label"><span class="glyphicon glyphicon-asterisk"></span>
							<s:message code='Question.Vytvorit.LBody'/></label>
						<div class="col-sm-9">
							<s:message code='Question.Vytvorit.PHBody' var='phBody'/>
					...
					<div class="form-group">
					    <label for="inputTestType" class="col-sm-3 control-label"><span class="glyphicon glyphicon-asterisk"></span>
					    	<s:message code='Question.Vytvorit.LTest'/></label>
					    <div class="col-sm-9 selectContainer">
					...
					<div class="form-group">
						...
						<s:message code='Question.Vytvorit.LIdPr'/></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label for="inputActive" class="col-sm-3 control-label"><span class="glyphicon glyphicon-asterisk"></span>
							<s:message code='Question.Vytvorit.LActive' /></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button type="submit" class="btn btn-info btn-lg confirm"><s:message code='Question.Vytvorit.BtnVytvorit' /></button>
						</div>
					</div>
